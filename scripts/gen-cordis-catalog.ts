...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsNavigation: 'client-side settings-section navigation service — packages/client/ui-settings/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmInputAdmission: 'llm-streaming.md',
