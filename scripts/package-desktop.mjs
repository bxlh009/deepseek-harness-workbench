...
async function main() {
  // Windows Defender and npm can briefly hold files from the previous
  // extraction. Retry the generated directory instead of failing a release
  // because a disposable build artifact was momentarily busy.
