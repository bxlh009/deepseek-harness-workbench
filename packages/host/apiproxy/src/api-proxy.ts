 ...
 * plugin-owned entries (`agent-loop`, `bash`, `web-search-anysearch`, `web-search-deepseek`) are the
...
const WEB_SETTINGS_NAMESPACES = [
  'agent-loop', 'shell', 'locale', 'permission', 'ui-conversation', 'ui-theme', 'web-search-anysearch', 'web-search-deepseek',
] as const
