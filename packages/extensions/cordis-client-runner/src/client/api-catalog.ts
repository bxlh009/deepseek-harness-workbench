...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'setCustomSkin(custom: CustomSkinSettings): void',
        description: 'Persist and apply a locally generated image skin. The payload contains a validated resized data URL and light/dark token pairs.',
        parameters: [{ name: 'custom', description: 'image-generated skin payload produced by the local analyser.' }],
      },
      {
        signature: 'clearCustomSkin(): void',
        description: 'Remove the persisted image skin and return to the classic built-in skin.',
        parameters: [],
      },
      {
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'CustomSkinSettings',
    declaration: 'export interface CustomSkinSettings {\n    name: string;\n    image: string;\n    preview: string;\n    tokens: ThemeTokenOverrides;\n}',
  },
  {
  ...
  {
    name: 'ThemeSkin',
    declaration: 'export type ThemeSkin = typeof THEME_SKINS[number];',
  },
  {
    name: 'ThemeSkinDefinition',
    declaration: 'export interface ThemeSkinDefinition {\n    id: ThemeSkin;\n    labelKey: \'skin.classic\' | \'skin.ocean\' | \'skin.forest\' | \'skin.sunset\' | \'skin.custom\';\n    previewToken: string;\n    previewValue?: string;\n    name?: string;\n    backgroundImage?: string;\n    tokens: ThemeTokenOverrides;\n}',
  },
  {
    name: 'ThemeSnapshot',
