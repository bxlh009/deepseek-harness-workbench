...
const PLAN_NEXT_ACTION_ZH = '描述任务，先生成执行计划'
...
export const zh = {
  ...
  'hero.headline': '开始一个编码任务',
  'hero.preview': '中文编码工作台',
  'hero.chooseWorkspace': '选择工作区',
  'hero.imageTile.explore': '探索并理解代码',
  'hero.imageTile.build': '构建新功能、应用或工具',
  'hero.imageTile.review': '审查代码并提出修改建议',
  'hero.imageTile.fix': '修复问题和失败',
...
export const en = {
  ...
  'hero.imageTile.explore': 'Explore and understand code',
  'hero.imageTile.build': 'Build features, apps, or tools',
  'hero.imageTile.review': 'Review code and suggest changes',
  'hero.imageTile.fix': 'Fix issues and failures',
