...
export type PluginsSettingsLocaleKey =
  ...
  | 'webSearchBaseUrl' | 'webSearchBaseUrlHint' | 'webSearchMaxResults' | 'webSearchMaxResultsHint'
...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchDescription: 'The AnySearch web search provider.',
  webSearchApiKey: 'API key',
  webSearchApiKeyHint: 'Stored outside the settings file. Leave blank to keep the current key.',
  webSearchApiKeySet: 'A key is configured.',
  webSearchApiKeyUnset: 'No key is configured; anonymous access may have lower quotas.',
  webSearchBaseUrl: 'Endpoint',
  webSearchBaseUrlHint: 'Leave blank to use the provider default.',
  webSearchMaxResults: 'Max results per request',
  webSearchMaxResultsHint: 'How many search results to return for one request.',
}
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchTitle: '网页搜索',
  webSearchDescription: 'AnySearch 网页搜索提供方。',
  webSearchApiKey: 'API Key',
  webSearchApiKeyHint: '不写入设置文件。留空表示保持当前密钥。',
  webSearchApiKeySet: '已配置密钥。',
  webSearchApiKeyUnset: '未配置密钥；仍可匿名搜索，但额度可能更低。',
  webSearchBaseUrl: '接口地址',
  webSearchBaseUrlHint: '留空则使用提供方默认地址。',
  webSearchMaxResults: '单次请求最多结果数',
  webSearchMaxResultsHint: '一次请求最多返回多少条搜索结果。',
}
