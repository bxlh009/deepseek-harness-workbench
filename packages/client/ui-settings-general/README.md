...
- The General section always offers a locale-aware update row in packaged desktop builds; other rows appear only when their owning feature plugins are mounted.
